...
client.on("message", async message => {
  ...
  client.user.setPresence({ activity: { name: 'yeah, because we stick together, and make sure our friends get help with what they need yeah, because we stick together, and make sure our friends get help with what they need' }, status: 'idle' })
